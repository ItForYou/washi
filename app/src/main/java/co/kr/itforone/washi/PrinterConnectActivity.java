...
import co.kr.itforone.washi.PrinterControl.BixolonPrinter;
...
public class PrinterConnectActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, AdapterView.OnItemClickListener, View.OnTouchListener, View.OnClickListener {
    ...
    private Button btnPrinterOpen,btnSettingBT;
    String input_text;
...
//        checkBoxAsyncMode = findViewById(R.id.checkBoxAsyncMode);
        ...
        btnSettingBT = findViewById(R.id.btnSettingBT);
        btnPrinterOpen.setOnClickListener(this);
        btnSettingBT.setOnClickListener(this);
        ...
        if(i!=null) {
            ...
            input_text = i.getStringExtra("input_text");
            if(input_text!=null && !input_text.isEmpty()){
                Log.d("getExtraStr", input_text);
            }
            ...
            case R.id.btnPrinterOpen:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (getPrinterInstance().printerOpen(portType, logicalName, address, true)) {
                            getPrinterInstance().printText(input_text,getPrinterInstance().ALIGNMENT_LEFT,
                                    getPrinterInstance().ATTRIBUTE_FONT_B, 1
                            );
                            finish();
                        }else{
                            mHandler.obtainMessage(1, 0, 0, "출력에 실패했습니다. 다시한번 확인해 주세요.").sendToTarget();
                        }
